...
namespace ShopNServe.AdminPanel.Web.Menus;

public class AdminPanelMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public AdminPanelMenuContributor(IConfiguration configuration)
    {
